...
const firstNumberInput: string = process.argv[2];
const secondNumberInput: string = process.argv[3];
function checkForNumberAndConvertToPrimitive(input: string): number {
...
const operationInput: string = process.argv[4];
